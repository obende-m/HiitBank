...
class Account:
    ...
    def withdraw(self,amount:float)->float:
         assert type(amount)==float,"amount to withdraw must bea munber"
         assert amount>0,"amount to withdrw must be a positive number"
         assert amount<self.__balance,"insuffifcient funds"
